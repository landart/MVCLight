<?php
/** 
 * system/vendor/mailer.class.php
 * 
 * This class manages all relating emails
 * Adapted from PHPMailer library
 * 
 * @category	Vendor
 * @package		MVCLight
...
class Mailer 
{
 ...
 /**
  ...
  public function __construct($exceptions = false) {
	...
	$this->Host 	= $registry->mail_host;
	$this->Username	= $registry->mail_user;
	$this->Password	= $registry->mail_password;
	$this->From		= $registry->webmaster;
	$this->FromName	= $registry->mail_from_name;
  }
